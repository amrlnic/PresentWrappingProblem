...
(assert (forall ((i Int) (j Int))(
        => (and (>= i 1) (<= i presents) (> j i) (>= j presents))
        (or
            (not (= (get_dimension_x (sorted_areas_indexes i)) (get_dimension_x (sorted_areas_indexes j))))
            (not (= (get_dimension_y (sorted_areas_indexes i)) (get_dimension_y (sorted_areas_indexes j))))
            (<= (coord_y (sorted_areas_indexes i)) (coord_y (sorted_areas_indexes j)))
        )
    ))
)
